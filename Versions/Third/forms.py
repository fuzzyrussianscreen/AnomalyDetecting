...
class App(Tk):
	...
	def __init__(self):
		...
		self.labelData = Label(fSelection, font="Courier 14",
		                       text="C:/Users/Dimon/PycharmProjects/AnomalyDetecting/Sources/facies_data/SHRIMPLIN.csv")
		...
		self.df, self.size_param = startSearch(self.labelData["text"])
		self.fig, self.axex = plt.subplots(nrows=self.size_param, ncols=1)
